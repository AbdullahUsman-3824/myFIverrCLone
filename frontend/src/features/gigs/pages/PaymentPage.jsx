...
const PaymentPage = () => {
  ...
  if (!gig || !selectedPackage) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-xl text-gray-600">No gig selected for payment.</div>
      </div>
    );
  }
  ...
  const validate = () => {
    ...
    if (!/^\d{16}$/.test(form.cardNumber.replace(/\s/g, ""))) errs.cardNumber = "Card number must be 16 digits";
      ...
      <div className="w-full max-w-4xl bg-white rounded-2xl shadow-xl flex flex-col md:flex-row overflow-hidden">
        ...
        <div className="md:w-1/2 p-8 bg-gray-50 border-r border-gray-200 flex flex-col justify-between">
          <div>
            ...
            <div className="mb-4">
              <div className="font-semibold text-gray-700 mb-1">{gig.title}</div>
              <div className="text-gray-500 text-sm mb-2">{gig.description?.slice(0, 80)}...</div>
          ...
          <div className="mt-8 text-xs text-gray-400">This is a demo payment page. No real payment will be processed.</div>
        </div>
        {/* Payment Form */}
        <form className="md:w-1/2 p-8 flex flex-col justify-center" onSubmit={handleSubmit} autoComplete="off">
          <h2 className="text-xl font-bold text-gray-800 mb-6">Pay with Card</h2>
          <div className="mb-4">
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors ${errors.name ? "border-red-400" : "border-gray-300"}`}
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={handleChange}
              maxLength={19}
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors ${errors.cardNumber ? "border-red-400" : "border-gray-300"}`}
          ...
          <div className="flex gap-4 mb-4">
            <div className="flex-1">
              ...
              <input
                ...
                onChange={handleChange}
                maxLength={5}
                className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors ${errors.expiry ? "border-red-400" : "border-gray-300"}`}
                placeholder="MM/YY"
                inputMode="numeric"
              />
            ...
            <div className="flex-1">
              ...
              <input
                ...
                onChange={handleChange}
                maxLength={4}
                className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors ${errors.cvv ? "border-red-400" : "border-gray-300"}`}
                placeholder="123"
                inputMode="numeric"
              />
