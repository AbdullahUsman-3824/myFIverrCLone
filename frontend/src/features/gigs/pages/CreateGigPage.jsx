...
import useCreateGigForm from "../hooks/useCreateGigForm";
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Fill in the details below to create your professional gig listing
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                <input
                  ...
                  max={365}
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors ${
                    errors.delivery_days ? "border-red-300" : "border-gray-300"
                  }`}
                />
              </InputField>
            ...
            {/* Image Upload */}
            <InputField label="Gig Media" error={errors.files} required>
              <ImageUploader
